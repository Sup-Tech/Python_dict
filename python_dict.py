...
"}")
        ...
        self.cre_date = QtWidgets.QLabel(self.tab_note)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cre_date.sizePolicy().hasHeightForWidth())
        self.cre_date.setSizePolicy(sizePolicy)
        self.cre_date.setMinimumSize(QtCore.QSize(55, 30))
        self.cre_date.setMaximumSize(QtCore.QSize(55, 30))
        self.cre_date.setSizeIncrement(QtCore.QSize(0, 50))
        self.cre_date.setBaseSize(QtCore.QSize(0, 50))
        self.cre_date.setObjectName("cre_date")
        self.gridLayout_4.addWidget(self.cre_date, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.note_profile, 1, 1, 1, 1)
        self.checkBoxNote = QtWidgets.QCheckBox(self.tab_note)
        self.checkBoxNote.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./img/lock.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap("./img/lock.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        self.checkBoxNote.setIcon(icon)
        self.checkBoxNote.setIconSize(QtCore.QSize(25, 25))
        self.checkBoxNote.setCheckable(True)
        self.checkBoxNote.setChecked(False)
        self.checkBoxNote.setAutoRepeat(False)
        self.checkBoxNote.setTristate(False)
        self.checkBoxNote.setObjectName("checkBoxNote")
        self.gridLayout_4.addWidget(self.checkBoxNote, 0, 4, 1, 1)
        self.new_button = QtWidgets.QPushButton(self.tab_note)
        self.new_button.setMinimumSize(QtCore.QSize(100, 0))
        self.new_button.setMaximumSize(QtCore.QSize(95, 16777215))
        self.new_button.setCheckable(False)
        self.new_button.setObjectName("new_button")
        self.gridLayout_4.addWidget(self.new_button, 1, 4, 1, 1)
        self.note_hint = QtWidgets.QLabel(self.tab_note)
        self.note_hint.setText("")
        self.note_hint.setObjectName("note_hint")
        self.gridLayout_4.addWidget(self.note_hint, 1, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.note_title, 0, 0, 1, 3)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./img/profileicon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cre_date.setText(_translate("MainWindow", "创建日期："))
        self.checkBoxNote.setText(_translate("MainWindow", "编辑"))
        self.checkBoxNote.setShortcut(_translate("MainWindow", "Ctrl+E"))
        self.new_button.setText(_translate("MainWindow", "新建"))
        self.new_button.setShortcut(_translate("MainWindow", "Ctrl+N"))
        self.note_title.setPlaceholderText(_translate("MainWindow", "标题"))
